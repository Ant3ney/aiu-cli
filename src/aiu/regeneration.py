...
def regenerate_artifact(course_root: str | Path, artifact_ref: str) -> list[str]:
...
def regenerate_week_range(course_root: str | Path, from_ref: str, to_ref: str) -> list[str]:
    ...
    return generate_lecture_week_range(course_root, start_week=start_week, end_week=end_week)
